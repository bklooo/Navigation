...
class Navbot9Spider(scrapy.Spider):
    name = 'navbot_9'
    start_urls = ['https://top.chinaz.com/hangye/index_yule_youxi.html/']

    def parse(self, response):
        item = SitespiderItem()
        if(response.status == 200):
            for i in response.xpath('//*[@id="content"]/div[4]/div[3]/div[2]/ul/li[position()>1]'):  # [position()>2]去除广告
            ...
            next_page = urljoin('https://top.chinaz.com/hangye/', response.xpath('//*[@id="content"]/div[4]/div[3]/div[2]/div[2]/a[11]/@href').get())
            print(next_page)
