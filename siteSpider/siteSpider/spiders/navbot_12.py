...
class Navbot11Spider(scrapy.Spider):
    name = 'navbot_12'
    start_urls = ['https://top.chinaz.com/hangye/index_zonghe_boke.html']
    ...
    def parse(self, response):
        ...
        if(response.status == 200):
            ...
            next_page = urljoin('https://top.chinaz.com/hangye/', response.xpath('//*[@id="content"]/div[4]/div[3]/div[2]/div[2]/a[10]/@href').get())
            print(next_page)
